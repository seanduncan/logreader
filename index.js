...
require('./solution/sync-sorted-merge')(syncLogSources, printers)
...
for (let i = 0; i < sourceCount; i++) {
	...
	asyncPrinters.push(new Printer())
}
require('./solution/async-sorted-merge')(asyncLogSources, asyncPrinters)